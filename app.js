...
*/
app.get('/jayahasan', function(request, response) {
    //response.send("<h2><center>Welcome to Node JS app</h2>");
    response.write("<h2><center><u>Node JS  Application </u></center></h2>");
	
    response.write("<h2><center>hi this is jayahasan if you need anything contact me on 9010980134 oor mail me at jayahasanjai8@gmail.com<center></h2>" );
    response.end();
